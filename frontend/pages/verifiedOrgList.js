...
export default function verifiedOrgList() {
  const [orgsList, setorgsList] = useState([
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      downVotes: 5,
      view: 56,
    ...
    },
    {
      ...
      downVotes: 5,
      view: 56,
      name: "The Alliance for Safe Children",
    },
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      downVotes: 5,
      view: 56,
      name: "Asbestos Disease Awareness Organization",
    },
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      downVotes: 5,
      view: 56,
      name: "Cardiac Risk in the Young",
    },
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      downVotes: 5,
      view: 56,
      name: "The Crohn's and Colitis Foundation of Canada",
    },
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      downVotes: 5,
      view: 56,
      name: "Global Village Foundation",
    },
    {
      cid: "bafybeigo3t5tj5cop433hlyszxndw6tar3bgficashpv5iwh7hqkqwpbpy",
      upVotes: 26,
      ...
      <div className=" bg-black ">
        <div className="h-auto py-3 flex flex-col items-center ">
          <h2 className="text-3xl font-extrabold text-white">
            List of Verified Organisations{" "}
          </h2>
