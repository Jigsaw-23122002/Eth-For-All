        ...
        <div className='m-6'>
            <div className="relative group h-full ">
                ...
                <div className="max-w-sm h-full p-6 m-2 relative bg-black rounded-lg leading-none">
                    ...
                    <button href="#" className="absolute bottom-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-transparent border border-white rounded-lg group-hover:bg-gradient-to-r from-blue-600 to-gray-600 ">
                        Read more
