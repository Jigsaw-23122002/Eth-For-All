    ...
    return (
        <div className='bg-black flex flex-col items-center '>
            ...
            <div className='p-6 grid grid-cols-4'>
                <embed src={`https://${query.cid}.ipfs.w3s.link/${fileName}`} className="col-span-3 w-full h-screen rounded-lg"></embed>
                <div class=" m-6 w-4/5 h-3/4 p-6 grid grid-rows-6 bg-transparent">
